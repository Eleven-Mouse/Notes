...
在博客项目里，Jenkins 是最先应该落地的工程化能力：**让你的博客从“本地手动打包部署”升级为“提交代码后自动构建、测试、打包、发布”。**

## 博客项目主线

推荐先做博客服务 CI，再做数据任务 CI：
...
| --- | --- |
| 初级 | 拉代码、编译、测试、打包 |
| 进阶 | 构建 Docker 镜像、推送镜像仓库 |
| 高级 | 部署 K8s、回滚、定时触发 Spark 任务 |
